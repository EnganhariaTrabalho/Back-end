...
module.exports = {
    ...
    update(formulario, cod_formulario) {
        try {
            ...
            return queryExecuter(connection, query, [
            formulario.semestre_curso, formulario.ultima_atualizacao_do_lattes, formulario.resultado_ultima_avaliação, formulario.aprovação_obrigatorias, 
            formulario.aprovação_optativas, formulario.conceitos, formulario.disciplinas_repovadas_curso, formulario.disciplinas_repovadas_semestre, 
